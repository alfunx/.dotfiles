...
function config.init(context)
    ...
    context.keys.global = gears.table.join(
        ...
        awful.key({ k.m                }, ",", function()
            awful.spawn.easy_async("rofi -show ssh", function() end)
        end,
                  { description = "show ssh menu (rofi)", group = "launcher" }),
        awful.key({ k.m                }, "-", function()
        ...
        -- Alt-tab support
        awful.key({ k.a, k.s           }, "Tab", function() awful.client.focus.byidx(-1) end,
                  { description = "focus previous client by index", group = "client" }),
        awful.key({ k.a                }, "Tab", function() awful.client.focus.byidx(1) end,
                  { description = "focus next client by index", group = "client" }),
        ...
        awful.key({                    }, "XF86AudioMute", function()
            awful.spawn.easy_async(string.format("amixer -q -D pulse set Master toggle"),
            function(stdout, stderr, reason, exit_code) --luacheck: no unused args
                beautiful.volume.manual = true
                beautiful.volume.update()
            end)
        ...
        awful.key({ k.c                }, "XF86AudioMute", function()
            awful.spawn.easy_async(string.format("amixer -q -D pulse set Master mute"),
            function(stdout, stderr, reason, exit_code) --luacheck: no unused args
                beautiful.volume.manual = true
                beautiful.volume.update()
            end)
        ...
        awful.key({                    }, "XF86KbdBrightnessUp", function()
            awful.spawn("kbd-backlight up")
        end),
        awful.key({                    }, "XF86KbdBrightnessDown", function()
            awful.spawn("kbd-backlight down")
        end),
