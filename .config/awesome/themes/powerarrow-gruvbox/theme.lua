...
--
--     local b_string_color = gears.color(theme.border_focus .. "33")
--     local b_arrow_color = gears.color(theme.border_focus .. "cc")
--     local b_weight = 4
...
--     -- end
--
--     -- seems like it does not occur when used in theme
--     total_height = total_height - 2 * (b_weight + b_gutter)
--
